...
if __name__ == '__main__':
    ...
    Ma1 = inputValue
    Ma2 = calc_Ma2(inputValue, gamma)
    p2dp1 = calc_p2dp1(inputValue, gamma)
    rho2drho1 = calc_rho2drho1(inputValue, gamma)
    T2dT1 = calc_T2dT1(inputValue, gamma)
    p02dp01 = calc_p02dp01(inputValue, gamma)
    p1dp02 = calc_p1dp02(inputValue, gamma)
    inputValuestar = calc_MaStar(inputValue, gamma)
    Ma1star = calc_MaStar(inputValue, gamma)
    Ma2star = calc_MaStar(Ma2, gamma)
    ...
    inputType = 0
    inputValue = Ma1
    print("Ma1 = {:.05f}".format(calcInflowMachnumber(inputType, inputValue, gamma)))

    inputType = 1
    inputValue = Ma2
    print("Ma1 = f(Ma2) = {:.05f}".format(calcInflowMachnumber(inputType, inputValue, gamma)))

    inputType = 2
    inputValue = p2dp1
    print("Ma1 = f(p2/p1) = {:.05f}".format(calcInflowMachnumber(inputType, inputValue, gamma)))

    inputType = 3
    inputValue = rho2drho1
    print("Ma1 = f(rho2/rho1) = {:.05f}".format(calcInflowMachnumber(inputType, inputValue, gamma)))

    inputType = 4
    inputValue = T2dT1
    print("Ma1 = f(T2/T1) = {:.05f}".format(calcInflowMachnumber(inputType, inputValue, gamma)))

    inputType = 5
    inputValue = p02dp01
    print("Ma1 = f(p02/p01) = {:.05f}".format(calcInflowMachnumber(inputType, inputValue, gamma)))

    inputType = 6
    inputValue = p1dp02
    print("Ma1 = f(p1/p02) = {:.05f}".format(calcInflowMachnumber(inputType, inputValue, gamma)))
