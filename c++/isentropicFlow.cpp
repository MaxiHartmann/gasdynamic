...
// constructor
zustand::zustand(int id, int inputType = 1, double inputValue = 2.0)
{
	index = id;
...
double zustand::calcMachnumber(int type, double value)
{
	double machnumber;
...
double zustand::findMaFromAratio(double Aratio, int flowType)
{
	// initial values
	double dM = 0.1;
	double M = 1e-6;
...
double zustand::findMaFromPM_Angle(double PM_Angle)
{
	// initial values
	// must be supersonic!
	double dM = 0.1;
...
double zustand::calc_AdAstar(double ma)
{
	double result;
